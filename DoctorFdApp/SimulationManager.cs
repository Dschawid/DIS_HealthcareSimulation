...
namespace DoctorFdApp
{
  public class CSimulationManager
  {
    ...
    public CDoctorFdApp federate; //Application-specific federate 
    ...
    private void initialize()
    {
      switch (federate.RTILibrary)
      {
        case RTILibraryType.HLA13_DMSO: case RTILibraryType.HLA13_Portico: case RTILibraryType.HLA13_OpenRti:
                ...
                federate.FederationExecution.FDD = @"C:\Users\bbyvj\Desktop\1531\HealthcareSimulation\DoctorFdApp\HealthcareSimulatorrFOM.fed";
        break;
        case RTILibraryType.HLA1516e_Portico: case RTILibraryType.HLA1516e_OpenRti:
                ...
                federate.FederationExecution.FDD = @"C:\Users\bbyvj\Desktop\1531\HealthcareSimulation\DoctorFdApp\HealthcareSimulatorrFOM.xml";
        break;
      }
    }
    #endregion //Methods
